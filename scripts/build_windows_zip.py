...
def build(output):
    ...
    names = ["README.md", "pyproject.toml", "setup-windows.cmd", "init-wechat-windows.cmd", "start-windows.cmd", "docs/windows.md", "docs/reference-notes.md", "docs/architecture.md", "docs/skills-security-review.md", "docs/relationship-method.md", "examples/demo.json"]
